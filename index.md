...
東大生同士の偶発的な出会いを支援する、ランチマッチングサービス。

ランディングページ:　[東大シャッフルランチ / UTokyo Shuffle Lunch - Google Sites](https://sites.google.com/view/lunch-utokyo)  
スライド: [プロジェクト報告スライド](https://drive.google.com/file/d/1B9nIZhK3wJqKRvie8n6t4bw06ewpt4wx/view?usp=sharing)

- 開発時期、期間：2020年 4月-6月　2ヶ月間
- 人数・役割：2人　役割分担なしの共同制作、運用
- 目的

    新型コロナウイルスの影響で全学オンライン授業になり、キャンパス内での偶発的な出会いが減ったこと問題意識を感じたため、学内でオンラインランチの相手を探せるサービスを作りたいと考えた。

- 苦労した点

    マッチングアルゴリズムの開発、日々の不具合への対応に苦労した。  
    ゲーム理論の基礎を学んだ上で、さらに1対1のマッチングだけでなく、複数人グループのマッチングも行えるように独自のアルゴリズムを開発した。
